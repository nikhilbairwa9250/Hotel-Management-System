...
#cur.execute("insert into paymentsf values(1,'Nikhil','Bairwa','9589861196','NikhilBairwa7673@gmail.com',2,'1','11','2018','11:20:27 PM','Cash','3500')")
...
Label(sroot,text="Nikhil Bairwa",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="Nikhil7673@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	root.title("Made with love by Nikhil")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Nikhil',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Nikhil Bairwa",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
